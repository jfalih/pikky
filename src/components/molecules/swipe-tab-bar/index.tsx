...
import { Dimensions, StyleSheet, Pressable, View, Easing, Platform } from 'react-native';
import Animated, {
  useAnimatedStyle,
  withSpring,
  interpolate,
  ...
  useAnimatedReaction(
    ...
    (current, previous) => {
      if (current !== previous && previous !== undefined) {
        ...
        const adjustedIndex = current > 0 ? current : 0;
    ...
    <Fragment>
      ...
      >
        <View
          style={[
            ...
            stylesFadeTabBar.tabBarBackgroundColor,
          ]}
        />
      </MaskedView>
      ...
      >
        <BoxAnimated
          ...
          pointerEvents="box-none"
          position={{
            bottom: bottom === 0 ? theme.spacing.large : bottom,
          }}
          width={tabBarContainerWidth}
          style={styles.tabBarBox}
        >
